  ...
  switch (visualizationType) {
    ...
    case "pie":
      ...
      const pieData = data.map(
        (item) => item.values[latestIdx] / scaleAttributes.factor
      );
    ...
    case "doughnut":
      ...
      const donutData = data.map(
        (item) => item.values[latestDonutIdx] / scaleAttributes.factor
      );
